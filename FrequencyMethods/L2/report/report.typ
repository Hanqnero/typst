...
=== Выводы
 Фурье-образ имеет вид кардинального синуса, график которого колеблется вокруг нуля.

Для прямоугольной функции параметр $a$ влияет на амплитуду Фурье-образа и самой функции, а параметр $b$ влияет на ширину функции и ширину спектра Фурье-образа.
